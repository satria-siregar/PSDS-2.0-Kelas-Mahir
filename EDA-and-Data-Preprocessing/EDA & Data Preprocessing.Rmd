...
![](E:\Kuliah\PSDS 2.0\Tugas 2\KM01 Header Notebook.png)
...
```{r}
df  <- read.csv("https://raw.githubusercontent.com/jokoeliyanto/Kelas-Mahir-Pejuang-Data-2.0/main/titanic.csv", stringsAsFactors = T)
df[df==""] <- NA
df[0:5,]
```
